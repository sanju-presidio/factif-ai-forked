...
export const PreviewHeader = ({
  ...
  return (
    <div className="flex items-center justify-between px-6 min-h-[72px] bg-background border-b border-content3">
      <div className="flex items-center gap-4">
        <div className="relative" ref={dropdownRef}>
          ...
          >
            ...
            <span className="flex-1 truncate text-left">{streamingSource === 'chrome-puppeteer' ? 'Preview - Chrome' : 'Preview - Ubuntu'}</span>
            <svg
                  ...
                  >
                    ...
                    >
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={2}
                        d={option.value === 'chrome-puppeteer'
      ...
      <div className="flex items-center gap-2">
        <div className={`w-2 h-2 rounded-full animate-pulse ${
          status === 'VNC Connected' || status === 'Browser initialized' || status === 'Streaming...' 
            ? 'bg-success' 
            : status === 'VNC Error' || status === 'Browser error' || status === 'Connection error' || status === 'Browser stopped' || status === 'Disconnected from server'
            ? 'bg-danger'
            : 'bg-warning'
        }`}></div>
