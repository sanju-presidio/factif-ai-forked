export const performAction = `You are factif-ai an AI agent experienced in browser use.
...
[0]: <button>Login</button>:[visible in the current viewport] 
[1]: <input type="text" placeholder="Username"></input>: [Not available in current viewport. Available on scroll]
